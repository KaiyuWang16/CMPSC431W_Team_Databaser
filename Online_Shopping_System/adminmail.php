...
<div id="container">
  ...
  <div id="mainContent">
    ...
    <div id="middletxtheadermain">
      ...
      <div id="middletxt1">
        <p align="center">Enter the Subject and Message.</p>
      </div>
      </div>
      <div id="middletxt">
              ...
              <td height="22"><table width="100%" border=0>
                  ...
                  <tr>
                    ...
                    <td><select name="selemail" id="selemail" style="width:300px;">
                        ...
                        <?php
                        $get_email= @mysql_query("SELECT email FROM registereduser")or die(mysql_error());
                        $num= @mysql_num_rows($get_email);
                        for($i=0;$i<$num;$i++)
                        {
                         $email= @mysql_result($get_email,$i,'email');
                        ?>
        ...
        <div align="center"><alt="mail image" width="200" height="150" /> </div>
        <!-- end #middletxt -->
      </div>
    </div>
    <!-- end #mainContent -->
 ...
 <?php
  if(isset($_POST['submitMain']))
  {
   ...
   $get= @mysql_query("SELECT * FROM admin")or die(mysql_error());
   $num= @mysql_num_rows($get);
   for($i=0;$i<$num;$i++)
   {
    $adm_email= @mysql_result($get,$i,'email');
   }
