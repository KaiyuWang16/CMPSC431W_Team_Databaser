...
<div id="container">
          ...
          <table width="100%" border=0>
            <tr>
              ...
              <tr>
				 ...
				 <input type="button" id="registerNew" name="registerNew" value="Register" Onclick="document.location.href='signup.php'" />
				 &nbsp;&nbsp;&nbsp
 ...
 if(isset($_POST['submitMain']))
 {
   ...
   $query = mysql_query("SELECT * FROM admin s WHERE s.mid = '".$user."' AND s.password = '".$password."' ")
   or die(mysql_error());
