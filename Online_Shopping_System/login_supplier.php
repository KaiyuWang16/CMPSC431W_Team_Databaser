...
<div id="container">
          ...
          <table width="100%" border=0>
            <tr>
              ...
              <tr>
				 ...
				 <input type="button" id="registerNew" name="registerNew" value="Register" Onclick="document.location.href='supplierregister.php'" />
				 &nbsp;&nbsp;&nbsp
 ...
 if(isset($_POST['submitMain']))
 {
   ...
   $query = mysql_query("SELECT * FROM supplier s WHERE s.companyName = '".$user."' AND s.password = '".$password."' ")
   or die(mysql_error());
   if(mysql_num_rows($query)>0)
   {
     $_SESSION['supplier']=$user;
     echo "<script>window.location='loghome_supplier.php';</script>";
   }
   else
   {
