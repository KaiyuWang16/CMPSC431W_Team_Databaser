...
<div id="subsidebar2">
 ...
 ?>
  ...
  <div id="mainContent">
    ...
    $cartcount=@mysql_query("SELECT * from cart WHERE userName='$username' AND s_id='$sid'");
    $ccount=@mysql_num_rows($cartcount);
    */?>
     <div id="middletxt">
       <div id="middletxtheader">
	<div style="float:left;">Bidding Products</div>
...
<?php
	...
	$targetpage = "bidproductsdisplay.php"; 	//your file name  (the name of this file)
	...
	$query="SELECT COUNT(*) AS num FROM bitem";
	...
	$sitems_query = "SELECT * FROM item, bitem WHERE item.tid = bitem.tid";
    ...
    for($i=0;$i<$num;$i++)
    {
	 ...
	 $pprice=@mysql_result($get, $i, 'reserverPrice');
 ...
 <tr>
   ...
   <td width="300"><p align="center">
	...
	<td width="500"><p align="center">
	            ...
	            Start Time : <?php echo $pstart;?> <br/></p>
	            <?php } ?>
				    <?php if($pend=="") { } else {?>
